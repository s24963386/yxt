	...
	<script type="text/javascript">
		...
		$(function(){
			edg = $('#dt-types').edatagrid({
				url:'<c:url value="/data/intercourseType/getItems"/>',
				saveUrl:'<c:url value="/data/intercourseType/save"/>',
				updateUrl:'<c:url value="/data/intercourseType/update"/>',
				destroyUrl:'<c:url value="/data/intercourseType/destroy"/>',

				tree:'#t-types',
				treeUrl:'<c:url value="/data/intercourseType/getTree"/>',
				treeDndUrl:'<c:url value="/data/intercourseType/dnd"/>'
