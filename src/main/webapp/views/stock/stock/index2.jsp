			...
			<table id="dg-stocks" class="easyui-datagrid"
				...
				<thead>
					<tr>
						...
						<th field="price" width="70" align="right" formatter="formatDecimal">均价</th>
						<th field="cost" width="80" align="right" formatter="formatDecimal">金额</th>
					</tr>
				</thead>
			</table>
		</div>
