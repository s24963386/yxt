	...
	<table cellpadding="0" cellspacing="0" style="width:100%">
		<tr>
			...
			<td style="text-align:right">
				<c:if test="${editable==true }">
					<a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-add" onclick="javascript:$('#dg-details').detailgrid('addGood',$('#depotId').combobox('getValue'))">添加商品</a>
	...
	<div style="padding-left:90px">
		<table cellpadding="0" cellspacing="0" class="form-table">
			...
			<tr>
				<td>调出仓库</td>
				<td>
					<input id="depotId" name="depotId" class="easyui-combobox" style="width:180px"
							value="${bill.depotId }"
				...
				<td>调入仓库</td>
				<td>
					<input name="depot2Id" class="easyui-combobox" style="width:180px"
							value="${bill.depot2Id }"
							url="<c:url value='/data/depot/getItems'/>"
							valueField="id" textField="name"
							required="true"></input>
