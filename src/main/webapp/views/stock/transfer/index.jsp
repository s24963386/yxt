...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#dg-bills').billgrid({
				createUrl:'<c:url value="/stock/transfer/create"/>',
				editUrl:'<c:url value="/stock/transfer/edit"/>',
				destroyUrl:'<c:url value="/stock/transfer/destroy"/>',
				query:{
					title:'查询商品调拨单',
					form:'<c:url value="/views/stock/transfer/_query.jsp"/>',
					width:450,
					height:230,
...
<body>
	<div class="easyui-layout" fit="true">
		...
		<div region="center" border="false">
			<table id="dg-bills" 
					url="<c:url value='/stock/transfer/getItems'/>"
				...
				<thead>
					<tr>
						...
						<th field="depotName" width="60">调出库房</th>
						<th field="depot2Name" width="60">调入库房</th>
						<th field="remark" width="100">备注</th>
						<th field="billCount" width="60" align="right">调拨数量</th>
						<th field="billCost" width="80" align="right" formatter="formatDecimal">调拨金额</th>
	...
	<div id="dlg-bill" class="easyui-dialog" title="调拨单" style="width:800px;height:410px;position:relative"
			closed="true">
	</div>
</body>
