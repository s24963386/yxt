	...
	<table cellpadding="0" cellspacing="0" style="width:100%">
		<tr>
			...
			<td style="text-align:right">
				<c:if test="${editable==true }">
					<a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-add" onclick="javascript:$('#dg-details').detailgrid('addGood1',{intercourseId:$('#intercourseId').combogrid('getValue'),depotId:$('#depotId').combobox('getValue')})">添加商品</a>
