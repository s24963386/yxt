...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$('#dg-bills').billgrid({
				createUrl:'<c:url value="/stock/rtnPurchase/create"/>',
				editUrl:'<c:url value="/stock/rtnPurchase/edit"/>',
				destroyUrl:'<c:url value="/stock/rtnPurchase/destroy"/>',
				query:{
					title:'查询采购退货单',
					form:'<c:url value="/views/stock/rtnpurchase/_query.jsp"/>',
					width:450,
					height:230,
...
<body>
	<div class="easyui-layout" fit="true">
		<div region="north" border="false">
			<div class="subtitle">采购退货单管理</div>
			<div class="toolbar">
		...
		<div region="center" border="false">
			<table id="dg-bills" 
					url="<c:url value='/stock/rtnPurchase/getItems'/>"
				...
				<thead>
					<tr>
						...
						<th field="depotName" width="60"">退货仓库</th>
						<th field="remark" width="100"">备注</th>
						<th field="billCount" width="60" align="right">退货数量</th>
						<th field="billCost" width="80" align="right" formatter="formatDecimal">退货金额</th>
	...
	<div id="dlg-bill" class="easyui-dialog" title="采购退货单" style="width:800px;height:410px;position:relative"
			closed="true">
	</div>
</body>
