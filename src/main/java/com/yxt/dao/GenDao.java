...
public class GenDao {
	...
	//数据库名
	private static final String schema = "yxt";
	//数据源
	private static final String datasource = "default";
	//DAO所在package
	private static final String pack = "com.yxt.dao";
	//生成源码的路径
	private static final String basePath = "E:/git_workspace/yxt/src/main/java/com/yxt/dao";
	//仅生成某个表的DAO时用
